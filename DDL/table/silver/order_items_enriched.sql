...
CREATE VIEW silver.order_items_enriched (
  order_id,
  order_item_id,
  product_id,
  seller_id,
...
AS WITH seller_stats AS (
    ...
    SELECT
        ...
        SUM(price) AS seller_total_revenue
...
SELECT
    ...
    ROUND(i.freight_value / NULLIF(i.price + i.freight_value, 1) * 100, 2) AS freight_pct_of_revenue,
